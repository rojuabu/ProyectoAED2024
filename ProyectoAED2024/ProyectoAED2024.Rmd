...
Vivienda_simple<-Vivienda[Vivienda$`General, vivienda nueva y de segunda mano`=='General' & Vivienda$`Índices y tasas`=='Variación anual',]

# Crear el gráfico
ggplot(Vivienda_simple, aes(x = Periodo, y = Total, color = `Comunidades y Ciudades Autónomas`)) +
  geom_line() +
  geom_point() +
  labs(
