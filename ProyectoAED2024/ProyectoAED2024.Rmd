...
```{r renombrar fotocasa, echo=FALSE}
...
```{r str de fotocasa, include=FALSE}
#Resumen de la estructura del dataset
str(fotocasa_compra)
```

Usando el comando `str`, se observa que la mayoría de las variables son de tipo numérico, excepto aquellas de coordenadas geográficas que son de tipo character, así como el distrito, el barrio o el año (siendo estas tres últimas convertibles a caracter o factor) y las referentes a coordendas geográficas.
 
```{r transformacion a caracter, include=FALSE}
