...
# Seleccionando las dos comunidades con mayor y menor salario medio en el 2022
...
g1 <- ggplot(primer_analisis_filtrado, aes(x = Periodo, y = Total, color = `Comunidades autónomas`)) +
  ...
  geom_point() +
  labs(
    title = 'Evolución del Sueldo Medio en las Comunidades Autónomas con Mayor y Menor Salario Medio (2022)',
    y = 'Total (€)',
