...
Para el caso de 2010, no se ha encontrado información suficiente para realizar una imputación correcta, por lo se decide aproximar por el precio de 2010 de aquellos distritos con un precio por metro cuadrado similar al de los distritos con valores faltantes en 2022. Además, el distrito que más se asemeja es el de L'Olivereta con 1162 €/m2. Vamos a imputar los valores faltantes de 2010 con este valor.
...
El análisis realizado nos ha permitido comprender mejor las dinámicas entre el precio de la vivienda y los salarios en España. Se observaron patrones relevantes que reflejan desafíos en términos de accesibilidad y sostenibilidad económica para la población en distintos puntos del país. Este estudio resalta como consecuencia la importancia de contar con políticas efectivas que aborden estos desafíos y fomenta la reflexión sobre cómo las tendencias actuales pueden afectar al futuro de la población en España en calidad de una vivienda y salario digno.
