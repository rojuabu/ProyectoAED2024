...
unique(Vivienda[is.na(Vivienda$Total),]$`Comunidades y Ciudades Autónomas`)
unique(Vivienda[is.na(Vivienda$Total),]$`Índices y tasas`)
unique(Vivienda[is.na(Vivienda$Total),]$`Periodo`)
```
